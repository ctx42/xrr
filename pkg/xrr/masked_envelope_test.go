...
func Test_MaskedEnvelope_Cause(t *testing.T) {
	// --- Given ---
	cause := New("cause", "ECC")

	// --- When ---
	err := EncloseMasked(cause, New("lead", "ECL"))
...
func Test_MaskedEnvelope_Lead(t *testing.T) {
	// --- Given ---
	lead := New("lead", "ECL")

	// --- When ---
	err := EncloseMasked(New("cause", "ECC"), lead)
